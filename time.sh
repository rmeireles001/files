...
set title \"Run statistics for time required to find best solution with $1 \" 0.000000,0.000000  font \"\"
set timestamp \"\" bottom norotate 0.000000,0.000000  \"\"
set rrange [ * : * ] noreverse nowriteback  # (currently [0.00000:10.0000] )
set trange [ * : * ] noreverse nowriteback  # (currently [-5.00000:5.00000] )
set urange [ * : * ] noreverse nowriteback  # (currently [-5.00000:5.00000] )
set vrange [ * : * ] noreverse nowriteback  # (currently [-5.00000:5.00000] )
set xlabel \"Run number \" 0.000000,0.000000  font \"\"
set x2label \"\" 0.000000,0.000000  font \"\"
set xrange [ 1 : *  ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
set x2range [ * : * ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
set ylabel \"Time required to find the best solution \" 0.000000,0.000000  font \"\"
...
set output \"$1.time.eps\"
#set terminal latex courier 12
#set output \"$1.time.tex\"
plot   \"$1.run.out\"  using 1:5 title \"Time requred to find the best solution\"  with linespoints "   >$1.time.gnu
