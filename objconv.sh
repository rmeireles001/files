...
set title \"Convergence history for Objective function for  $1 \" 0.000000,0.000000  font \"\"
...
set output \"$1.obj.eps\"
#set terminal latex courier 12
#set output \"$1.obj.tex\"
plot  \"$1.plot.out\" using  1:2 title \"Iteration Best\" with linespoints 2 5 , \"$1.plot.out\"  using 1:3 title \"Global Best\"  with linespoints 1 3 "   >$1.obj.gnu
