...
set title \"Run statistics for iterations required with $1 \" 0.000000,0.000000  font \"\"
...
set ylabel \"Iterations \" 0.000000,0.000000  font \"\"
...
#set output \"$1.iter.pdf\"
set terminal postscript enhanced eps  color dashed  \"Times-Roman\" 16
set output \"$1.iter.eps\"
#set terminal latex courier 12
#set output \"$1.iter.tex\"
plot   \"$1.run.out\"  using 1:4 title \"Iterations requred to find the best solution\"  with linespoints   "   >$1.iter.gnu
