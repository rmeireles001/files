...
set title \"Construction graph and  best path found by the ants for $1 \" 0.000000,0.000000  font \"\"
set timestamp \"\" bottom norotate 0.000000,0.000000  \"\"
set rrange [ * : * ] noreverse nowriteback  # (currently [0.00000:10.0000] )
set trange [ * : * ] noreverse nowriteback  # (currently [-5.00000:5.00000] )
set urange [ * : * ] noreverse nowriteback  # (currently [-5.00000:5.00000] )
set vrange [ * : * ] noreverse nowriteback  # (currently [-5.00000:5.00000] )
set xlabel \"Variable No.\" 0.000000,0.000000  font \"\"
set x2label \"\" 0.000000,0.000000  font \"\"
set xrange [ 0 : *  ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
set x2range [ * : * ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
set ylabel \"Variable value No.\" 0.000000,0.000000  font \"\"
...
set output \"$1.constructiongraph.eps\"
#set terminal latex  
#set output \"$1.constructiongraph.tex\"
plot  	\"$1.graph.out\"  using 1:2 title \"nodes\" with points 4 6
	 
"   >>$1.constructiongraph.gnu
