...
set title \"Convergence history for statistics for  $1 \" 0.000000,0.000000  font \"\"
...
set ylabel \"Objective function\" 0.000000,0.000000  font \"\"
...
set output \"$1.dev.eps\"
#set terminal latex courier 12
#set output \"$1.dev.tex\"
plot 	\"$1.stat.out\" using  1:2 title \"Iteration Best\" with linespoints  ,\
	\"$1.stat.out\"  using 1:3 title \"Iteration worst \"  with linespoints  ,\
	\"$1.stat.out\"  using 1:4 title \"Iteration mean \"  with linespoints ,\
	\"$1.stat.out\"  using 1:5 title \"Iteration  stddev \"  with linespoints   "  >$1.dev.gnu
