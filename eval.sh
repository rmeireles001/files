...
set title \"Run statistics for evaluations required with $1 \" 0.000000,0.000000  font \"\"
...
set ylabel \"Evaluations \" 0.000000,0.000000  font \"\"
...
set output \"$1.eval.eps\"
#set terminal latex courier 12
#set output \"$1.eval.tex\"
plot   \"$1.run.out\"  using 1:6 title \"Evaluations requred to find the befa;lsdjfk;lajt solution\"  with linespoints   "   >$1.eval.gnu
