...
set title \"Run statistics for $1 \" 0.000000,0.000000  font \"\"
...
set output \"$1.run.eps\"
#set terminal latex courier 12
#set output \"$1.run.tex\"
plot  \"$1.run.out\" using  1:2 title \"Obj-function\" with linespoints    "   >$1.run.gnu
